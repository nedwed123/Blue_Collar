...
/**
 * This is the item provider adapter for a {@link SoftwareModel.Presentation.Frame} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FrameItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Frame_currentView_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Frame_currentView_feature", "_UI_Frame_type"),
				 PresentationPackage.Literals.FRAME__CURRENT_VIEW,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_Frame_type");
	}
